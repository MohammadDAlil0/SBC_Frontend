...
function Footer() {
  return (
    <footer className=" border-t pt-8 pb-2 px-6 container-padding">
      <div className="flex flex-col-reverse md:flex-row gap-5 justify-between items-center text-sm text-gray-500">
        ...
        <div className="text-left">
          <div className="text-[30px] font-bold relative mb-2">
            <span className="text-primary relative top-[5px] z-[2]">
              +Insured
            </span>
      ...
      <p className="text-center md:text-[20px] text-[16px] text-[#7D7D7D] mt-10 border-t py-4 border-[#DADADA]">
        cart-wheel.net 2025 All rights reserved
      </p>
    </footer>
  )
}
